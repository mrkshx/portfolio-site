  ...
  render() {
    return(
        <div id="aboutpage" >
            ...
            <Container>
              <Image className="avatar mb-5" cloudName={process.env.REACT_APP_CLOUDINARY_CLOUDNAME} publicId="landing_avatar_oerydq" width="250" height="250" crop="thumb" gravtity="face-center" radius="max" />
